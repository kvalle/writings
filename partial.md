...
It's not often arriving on the night before a conference is one of the highlights. At Partial it was, though. We were actually picked up at the airport by a representative from the organizers, whom, after letting us drop our luggage of at the AirBnB, drove us to the location where the speakers dinner were taking place. Here we got to taste som of the local cuisine, as well as their fruit brandy _Rakia_.


## The program
	
Partial is a single track, two day conference. The [program](http://partialconf.com/schedule) consisted of 40 minutes talks throughout the first day, and before lunch on the second. The last afternoon was dedicated to workshops (with ours being one of them).

On the evening of the first day there was nothing on the program, which suited us perfectly after traveling the day before, attending speakers dinner (with more than enough Rakia), and a long day of presentations. On the second night there were a party at a local nightclub.

> TODO: Noe mer om hva som skjedde her?
...
> TODO: Må få inn noen bilder fra noen av foredragene.

There are a few talks we would like to highlight:
...
In his talk, however, he focused on the parts of the language that he _doesn't_ like. He had complaints both technical in nature, and about how the community and language is being run. A really good talk, stripped of any of the "hallelujah" factor that many talks about programming languages often have.
...
Partial is a small but fun conference, with quality talks, and really nice people. 

> TODO: En setning eller to til som oppsummering?
